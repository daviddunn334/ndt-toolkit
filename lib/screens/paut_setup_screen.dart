...
import '../data/paut_setup_kb_data.dart';
import '../models/kb_section.dart';
import '../theme/app_theme.dart';

class PautSetupScreen extends StatefulWidget {
  const PautSetupScreen({super.key});

  @override
  State<PautSetupScreen> createState() => _PautSetupScreenState();
}

class _PautSetupScreenState extends State<PautSetupScreen> {
  ...
  List<KbSection> get _filteredSections {
    if (_searchQuery.isEmpty) {
      return pautSetupKbData;
    }

    return pautSetupKbData.where((section) {
                        ...
                        return Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  'Quick reference only — validate against procedure and calibration.',
                                  style: TextStyle(
                                    fontSize: 13,
                                    color: AppTheme.textSecondary,
                                    height: 1.4,
